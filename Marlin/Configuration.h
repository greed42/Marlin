...
#define STRING_CONFIG_H_AUTHOR "(NiXXiN / greed, Ender-3 Pro SKR 1.4T)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro SKR1.4T"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 98.25 }
